...
- Manually:
  ...
  Download the [latest release](https://github.com/GoogeTan/millij/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>


This plugin uses icons(millFile) from [scala plugin](https://github.com/JetBrains/intellij-scala)
